...
Run:    python -m fxresearch.models.classical.estimate_dynamics            (EURUSD USDJPY USDCNH)
        python -m fxresearch.models.classical.estimate_dynamics --all      (all 10 pairs)
        python -m fxresearch.models.classical.estimate_dynamics --pairs EURUSD --sensitivity

Outputs:
    data/derived/dynamics_params_<PAIR>.parquet   daily-sampled parameter stream
    data/derived/dynamics_summary.json            parameter ranges + diagnostics
"""
