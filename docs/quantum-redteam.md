...
- Direct qutrit filter: `engine/quantum/quantum_lindblad.py`; its 250,000-row replay
  has zero cross-gap state updates but fails causal baseline comparison.
- Monte Carlo wavefunction qutrit: `engine/quantum/quantum_trajectories.py`; its
