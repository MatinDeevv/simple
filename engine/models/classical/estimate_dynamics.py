...
Run:    python -m engine.models.classical.estimate_dynamics            (EURUSD USDJPY USDCNH)
        python -m engine.models.classical.estimate_dynamics --all      (all 10 pairs)
        python -m engine.models.classical.estimate_dynamics --pairs EURUSD --sensitivity
